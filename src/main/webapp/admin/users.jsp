...
<div class="container">
    ...
    <table class="table">
        ...
        <c:forEach var="c" items="${candidates}">
            <tr>
                ...
                <td>${c.active}</td>
                <td>
                    <form method="post" action="${pageContext.request.contextPath}/admin/users/action" style="display:inline-block">
    ...
    <h5>Employers</h5>
    <table class="table">
        <thead><tr><th>ID</th><th>Company</th><th>Email</th><th>Active</th><th>Actions</th></tr></thead>
        <tbody>
